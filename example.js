...
Complains.check({
    ...
    warranty: true, // True means you are ok with the fact that the dependency doesn't give you warranty
    liability: true, // True means you are ok with the fact that the dependency doesn't give you liability
